...
<div class="pt-3">
<h4 class="card-title text-center">Список рефералов:</h4>
...
<?PHP
$ref = $db->query("SELECT login, ref_to, refsite, reg, money_b, money_p FROM db_users WHERE id = id AND rid = '$id' ORDER BY ref_to DESC")->fetchAll();
	foreach($ref as $r){
?>
<tr>
	<td><?=$r['login']; ?></td>

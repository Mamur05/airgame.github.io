...
<b><i class="fa fa-bars ml-1" style="margin-right: 5px;width: 20px;text-align: right;"></i> Админ-панель</b>
	...
	<ul class="navbar-nav">
		...
		<li class="nav-item"><a class="nav-link" href="/<?=$adm;?>/contest_inv"><i class="fa fa-gift"></i> Инвест конкурс</a></li>
		...
		<li class="nav-item"><a class="nav-link" href="/<?=$adm;?>/feik"><i class="fa fa-users"></i> Фейки</a></li>

...
# Уровни
if($dep <= 9) {$day = 1;}
elseif ($dep >= 10 and $dep < 99) {$day = rand(1, 2);}
elseif ($dep >= 100 and $dep < 249) {$day = rand(2, 5);}
elseif ($dep >= 250 and $dep < 499) {$day = rand(5, 10);}
elseif ($dep >= 500 and $dep < 999) {$day = rand(10, 15);}
elseif ($dep >= 1000 and $dep < 2499) {$day = rand(15, 25);}
elseif ($dep >= 2500 and $dep < 4999) {$day = rand(25, 50);}
elseif ($dep >= 5000 and $dep < 9999) {$day = rand(50, 100);}
elseif ($dep >= 10000) {$day = 100;}
...
Бонус выдается каждые 24 часа, на покупки. <br/>
Сумма бонуса генерируется случайно от <font class="text-danger"><b>0.01</b></font> до <font class="text-danger"><b>1.00</b></font> руб.<br/>
...
Сумма пополнения меньше 10 руб. = <b>бонус всегда 0.01 руб.</b><br/>
Сумма пополнения 10 - 99 руб. = <b>бонус от 0.01 до 0.02 руб.</b><br/>
Сумма пополнения 100 - 249 руб. = <b>бонус от 0.02 до 0.05 руб.</b><br/>
Сумма пополнения 250 - 499 руб. = <b>бонус от 0.05 до 0.10 руб.</b><br/>
Сумма пополнения 500 - 999 руб. = <b>бонус от 0.10 до 0.15 руб.</b><br/>
Сумма пополнения 1000 - 2499 руб. = <b>бонус от 0.15 до 0.25 руб.</b><br/>
Сумма пополнения 2500 - 4999 руб. = <b>бонус от 0.25 до 0.50 руб.</b><br/>
Сумма пополнения 5000 - 9999 руб. = <b>бонус от 0.50 до 1.00 руб.</b><br/>
Сумма пополнения свыше 10000 руб. = <b>бонус 1.00 руб.</b><br/>
</div>
</div>
...
if(isset($_POST["bonus"])){
	...
	echo '<div class="alert alert-success">На счет для вывода зачислен бонус!</div>';
	$hide = true;
}

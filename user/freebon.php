...
$opt['title'] = 'Денежный билет';
?>
 <div class="alert bg-light text-center">
Испытай свою удачу, пополняй игровой баланс и получай денежный билет!<br/>
За каждое пополнение на сумму <b>100 руб.</b> Вам начисляется <b>1 билет</b>, которые можно испытать бесплатно!<hr class="my-1">
<b>ВЫ МОЖЕТЕ ПОЛУЧИТЬ С ОДНОГО ДЕНЕЖНОГО БИЛЕТА: <b class="text-danger">1, 2, 3, 5, 10, 25, 50 РУБЛЕЙ</b> НА ВЫВОД!</b>
</div>

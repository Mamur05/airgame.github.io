...
?>
<div class="wrapper" style="max-width: 580px;margin: 0 auto;">

<h4>Введите Email вашего аккаунта, на него будет выслан новый пароль для доступа.</h4>
...
<div class="form-group mb-2"><input class="form-control  form-control-lg" name="email" type="email" placeholder="Email почта" value=""></div>

<button name="restore" type="submit" class="btn btn-lg btn-success">ВОССТАНОВИТЬ</button>
</form>
</div>